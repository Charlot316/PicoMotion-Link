...
# 2. 启动服务
echo ">>> 启动数据中心与视频流中转..."
/Users/charlotfirth/miniforge3/bin/python3.12 "$PROJECT_DIR/fast_receiver.py" &
RECEIVER_PID=$!

/Users/charlotfirth/miniforge3/bin/python3.12 "$PROJECT_DIR/video_streamer.py" &
VIDEO_PID=$!

/Users/charlotfirth/miniforge3/bin/python3.12 -m http.server 8000 > /dev/null 2>&1 &
HTTP_PID=$!
